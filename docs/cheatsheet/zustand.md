...
> [Zustand](https://github.com/pmndrs/zustand) - инструмент для управления состоянием `React-приложений`, наиболее полно (среди более чем многочисленных альтернатив) отвечающий моим представлениям о, если не идеальном, то адекватном современному `React` инструменту для управления состоянием.
