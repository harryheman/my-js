...
### Как передавать аргументы в обработчик событий или функцию обратного вызова?
...
<p align="center">
  <img src="../assets/img-v2/reconciliation.jpg" alt="reconciliation" />
</p>
...
### Как определить версию React в приложении, запущенном в браузере?
...
Существуют и другие способы. *Обратите внимание:* браузер будет "жаловаться" на отсутствие сертификата безопасности.
...
<p align="center">
  <img src="../assets/img-v2/react-routing.png" alt="React Router" />
</p>
...
Стилизованные компоненты - это библиотека для `React` и `React Native`, позволяющая использовать стили на уровне компонента и смешивать `CSS` и `JavaScript`. Данная техника называется "CSS-in-JS":
...
<p align="center">
  <img src="../assets/img-v2/react-twoway-data-binding.png" alt="Two way Data Binding" />
</p>
...
class App extends React.Component {
  render() {
    return <h1>Пример обычного компонента</h1>
  }
}
...
*Стрелочная функция* - это одновременно создает и привязывает функцию к экземпляру. Внутри метода `render` контекстом функции будет экземпляр компонента:
...
<p align="center">
  <img src="../assets/img-v2/shadow-dom.png" alt="DOM" />
</p>
...
Одним из способов распределения состояния между двумя компонентами является определение состояния в их родительском компоненте. Такой подход называется подъемом состояния. Изменения общего состояния незамедлительно отражаются на соответствующих компонентах.
...
Композиция - это также концепция `ООП`. Однако, вместо наследования свойств базового класса, "расширяемый" класс ссылается на экземпляры другого класса:
...
<p align="center">
  <img src="../assets/img-v2/useLayoutEffect.png" alt="useLayoutEffect" />
</p>
...
<p align="center">
  <img src="../assets/img-v2/redux-components.jpg" alt="Redux Components" />
</p>
...
<p align="center">
  <img src="../assets/img-v2/redux-state.png" alt="Redux State" />
</p>
...
*2. Состояние является доступным только для чтения*: единственный способ изменить состояние - отправить операцию, т.е. объект, описывающий произошедшее.
...
<p align="center">
  <img src="../assets/img-v2/redux-workflow.png" alt="Redux Workflow" />
</p>
...
<!-- ### Как реализовать создателя операции? -->
...
<p align="center">
  <img src="../assets/img-v2/redux-data-flow.gif" alt="Redux Data Flow" />
</p>
...
### Как реализовать побочный эффект, такой как AJAX-запрос? Зачем нам нужны такие вещи, как action creators, thunks и middleware для реализации асинхронного поведения?
...
### Что означает символ *@* (коммерческое "at") в декораторе `connect`?
...
<p align="center">
  <img src="../assets/img-v2/flux-structure.png" alt="Flux" />
</p>
...
<p align="center">
  <img src="../assets/img-v2/flux-architecture.png" alt="Flux Architecture" />
</p>
...
<p align="center">
  <img src="../assets/img-v2/redux-architecture.png" alt="Redux Architecture" />
</p>
...
* Диспетчер принимает операции и является своего рода единым реестром колбеков всех хранилищ приложения. Он также управляет зависимостями между хранилищами
...
<p align="center">
  <img src="../assets/img-v2/flux-2.png" alt="Flux" />
</p>
...
### Как добавить несколько middleware?
...
Реактивное расширение для JavaScript. Библиотека для реактивного программирования с помощью наблюдаемых объектов (издателей). Позволяет легко комбинировать асинхронный или основанный на колбеках код.
...
<p align="center">
  <img src="../assets/img-v2/redux-thunk.jpeg" alt="Redux Thunk" />
</p>
...
<p align="center">
  <img src="../assets/img-v2/redux-saga.png" alt="Redux Saga" />
</p>
...
<p align="center">
  <img src="../assets/img-v2/react-redux-form.png" alt="React Redux Form" />
</p>
